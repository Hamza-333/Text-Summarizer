...
### Model Parameters
The model has 2 encoder and decoder layers. Each encoder contains 4 attention Heads forming the Multi-head attention mechanism, 1 feed-forward network, and 2 Layer normalization layers. Each of these have a certain number of parameters.
